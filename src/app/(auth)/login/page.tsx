    ...
    <Form {...form}>
      <form onChange={()=>{
        ...
        items-center'>
          ...
          dark:text-white
          text-4xl
          first-letter:ml-2'>AfterSync</span>
        </Link>
        ...
        <Button type='submit'
        className='w-full p-6' size="lg" disabled={isLoading}>{!isLoading ? "Login": <Loader/>}</Button>
        <span className='self-container'>
          Don't have an account?
          <Link href="/signup" className='ml-2 text-primary'>Sign up</Link>
        </span>
