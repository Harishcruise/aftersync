...
const HomePage = () => {
  return (
    <>
        ...
        md:justify-center
        md:items-center'>
            <TitleSection pill='🤷‍♂️ Your workspace, Perfected' title='All-In-One Collaboration and Productivity platform' ></TitleSection>
          ...
          {[...Array(2)].map((arr,index)=>(
            ...
            className={twMerge(
              ...
              {USERS.map((test,index)=>(
                <CustomCard key={test.name} className='w-[500px]
                shrink-0
                rounded-xl
                ...
                gap-4'>
                  ...
                  <CardDescription className='dark:text-washed-purple/washed-purple-800'>
                    {test.name.toLocaleLowerCase()}
                  </CardDescription>
                  </div>
                </div>}

                cardContent={
                  <p className='dark:text-washed-purple/washed-purple-800'>{test.message}</p>
                }
                ></CustomCard>
              ))}
            </div>
